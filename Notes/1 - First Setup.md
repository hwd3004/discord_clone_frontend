https://youtu.be/OsDW_ulfhdY

```
nestJS 백엔드 프로젝트 생성
nest new discord_clone_backend

vite + react + typescript 프론트엔드 프로젝트 생성
npm create vite@latest
이름은 discord_clone_frontend
```

<hr/>

```
https://blog.haenu.com/8 - Mantine에 대한 소개

Mantine은 리액트에서 사용할 수 있는 UI 컴포넌트 라이브러리이다. svelte와 vue도 지원한다.
NextJS에서 사용 시에는 주의가 필요한듯 하다.
```
